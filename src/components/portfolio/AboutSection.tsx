          ...
          <div className="space-y-6">
            <Reveal delay={0.1}>
              <div className="neobrutalist-card p-8 space-y-4 relative group hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-foreground/80 leading-relaxed text-sm md:text-base lg:text-lg">
              ...
              <div className="neobrutalist-card p-8 space-y-4 relative group hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="space-y-2">
                  <p className="text-foreground/70 text-sm md:text-base lg:text-lg">
                    Here is a little more about myself that you may find
                    interesting:
                  </p>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="stat-badge text-sm">
                      University of East London
                    </span>
                    <span className="stat-badge text-sm">London, UK</span>
                    <span className="stat-badge text-sm">
                      120+ Repositories
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {interests.map((interest, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`p-2 bg-${interest.color}/10 border border-${interest.color}/30`}
                        >
                          <Icon
                            size={16}
            ...
            <Reveal delay={0.25}>
              ...
              >
                ...
                <span className="relative font-semibold tracking-wide text-primary-foreground uppercase text-xsm group-hover:tracking-wider transition-all duration-300">
                  View Resume
                </span>
